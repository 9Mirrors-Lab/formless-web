...
export function useIconAnimations(scope: React.RefObject<HTMLElement | null>) {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tlShift
        .to('.shift-diamond', { rotation: 45, scale: 0.8, duration: 1.5, ease: 'power2.inOut', transformOrigin: '50% 50%' })
      ...
      tlTangle
        .to('.tangle-chaos', { opacity: 0, scale: 0.8, duration: 1.5, ease: 'power1.inOut', transformOrigin: '50% 50%' }, 0)
        .fromTo(
          '.tangle-straight',
          { opacity: 0, scaleX: 0 },
          { opacity: 1, scaleX: 1, duration: 1.5, ease: 'power2.inOut', transformOrigin: '50% 50%' },
          0.5,
        );
      ...
      tlRift
        ...
        .to('.rift-core', { opacity: 0.9, scale: 1.5, duration: 3, ease: 'power2.inOut', transformOrigin: '50% 50%' }, 0);
