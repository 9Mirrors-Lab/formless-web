...
export const BRAND_DESIGNS: readonly BrandDesign[] = [
  ...
  },
  {
    ...
    versions: [
      ...
      {
        id: 'intended',
        label: 'Intended waitlist letter',
        role: 'intended',
  ...
  },
  {
    ...
    owner: 'Soni',
    usedFor:
      'The coded waitlist send. Jacket, Introduction listen, and a short thank-you. Paste /emails/formless-waitlist-zoho.html into Zoho Campaigns.',
    href: '/email-previews/waitlist-intended.html',
    ...
    versions: [
      {
        ...
        label: 'Coded letter',
        role: 'intended',
        filename: 'waitlist-intended.html',
        previewSrc: '/design/previews/formless-waitlist-email-html.png',
        href: '/email-previews/waitlist-intended.html',
        notes: 'Zoho-ready HTML. Paste /emails/formless-waitlist-zoho.html. Merge tags $[FNAME]$ and $[UNSUBSCRIBE]$.',
      },
    ],
    source: 'public/email-previews/waitlist-intended.html',
    notes: 'The photograph on Stay Close is the Canva-failed reference. This row is the coded send.',
  },
  {
    id: 'kindle-preorder',
    ...
    owner: 'Soni',
    usedFor:
      'Soni sends this when the Kindle page is open. Cover, $0.99, September 1, one button to Amazon.',
    ...
    versions: [
      {
        ...
        href: '/emails/formless-preorder.html',
        notes: 'Light cream letter. Paste into Zoho as a template.',
      },
    ],
