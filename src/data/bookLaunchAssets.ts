...
export const LAUNCH_CALENDAR: readonly LaunchCalendarRow[] = [
  ...
  },
  {
    ...
    when: 'Fri Aug 28',
    runway: 'before',
    channel: 'Waitlist + LinkedIn',
    piece: 'The book is nearly here. Who it is for.',
    dependsOn: 'Waitlist and Stay Close can actually receive mail.',
  },
  {
    id: 'cal-aug29',
    when: 'Sat Aug 29',
  ...
  },
  {
    ...
    runway: 'launch',
    channel: 'Warm + waitlist + advance listen',
  ...
  },
  {
    ...
    runway: 'after',
    channel: 'Warm + waitlist + LinkedIn',
