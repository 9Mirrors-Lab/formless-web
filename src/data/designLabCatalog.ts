...
export const DESIGN_LAB_ENTRIES: DesignLabEntry[] = [
  ...
  {
    id: 'science-explore',
    label: 'Science · live concepts',
    href: '/science-explore',
    group: 'Directions',
    intent: 'Observatory, icon atlas, specimen index, witness nucleus, bridge ledger. Same copy, different icons and lockups.',
    status: 'Direction',
  },
  {
    id: 'monument-home',
    ...
    href: '/monument-home',
    group: 'Directions',
    intent: 'Southwestern surreal home. Matte charcoal, monoliths, horizon light, architectural negative space.',
    status: 'Direction',
  },
  {
    id: 'monument-book',
    ...
    href: '/monument-book',
    group: 'Directions',
    intent: 'Same book copy in slab layout. Dust red and turquoise-gray accents, no production card chrome.',
    status: 'Direction',
  },
  {
