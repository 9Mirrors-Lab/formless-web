...
export default function ClientSiteUpdatesPage() {
  ...
  return (
    <PageLayout>
      <section className="site-page-header relative w-full overflow-hidden px-6 pb-16 pt-8 md:px-16 md:pb-20 lg:px-24">
      ...
      <section className="w-full border-t border-charcoal/10 bg-charcoal px-6 py-20 text-cream md:px-16 lg:px-24">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="font-serif text-4xl italic md:text-5xl">{CLIENT_SITE_UPDATES_CLOSING.title}</h2>
